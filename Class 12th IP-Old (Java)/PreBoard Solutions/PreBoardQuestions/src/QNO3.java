 ...
 * @author Roshaa
 */
public class QNO3 extends javax.swing.JFrame {

    /**
     * Creates new form QNO3
     */
    public QNO3() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        {
            JOptionPane.showMessageDialog(null, "Please Enter First Number","Message",
                    JOptionPane.INFORMATION_MESSAGE);  
        }
         else if(jTextField2.getText().equals(""))
        {
            JOptionPane.showMessageDialog(null, "Please Enter Second Number","Message",
                    JOptionPane.INFORMATION_MESSAGE);  
        }
        else
         {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QNO3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
